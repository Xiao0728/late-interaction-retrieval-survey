...
| Spike Hijacking | 2026 · arXiv / LIR Workshop | [Spike Hijacking in Late-Interaction Retrieval](https://arxiv.org/abs/2604.05253) | Investigates hard-max aggregation and smoother alternatives. |
...
| ColBERTv2 | 2022 · NAACL | [ColBERTv2: Effective and Efficient Retrieval via Lightweight Late Interaction](https://aclanthology.org/2022.naacl-main.272/) | Residual compression reduces stored token-vector payload. |
...
| Jina-ColBERT-v2 | 2024 · MRL Workshop | [Jina-colbert-v2: A general-purpose multilingual late interaction retriever](https://aclanthology.org/2024.mrl-1.11/) | Reduced embedding dimensionality directly targets storage. |
| Matching and pruning analysis | 2024 · TOIS | [An Analysis on Matching Mechanisms and Token Pruning for Late-Interaction Models](https://doi.org/10.1145/3639818) | Token-pruning analysis directly informs representation reduction. |
...
| SCV | 2025 · COLING Industry | [SCV: Light and Effective Multi-Vector Retrieval with Sequence Compressive Vectors](https://aclanthology.org/2025.coling-industry.63/) | Sequence-compressive vectors reduce stored representation size. |
| ColBERTSaR | 2026 · arXiv | [ColBERTSaR: Sparsified ColBERT Index via Product Quantization](https://arxiv.org/abs/2606.05568) | Product quantization reduces index storage. |
...
| SCV | 2025 · COLING Industry | [SCV: Light and Effective Multi-Vector Retrieval with Sequence Compressive Vectors](https://aclanthology.org/2025.coling-industry.63/) | Its coarse-to-fine retrieval design also changes candidate retrieval. |
...
| ColBERTSaR | 2026 · arXiv | [ColBERTSaR: Sparsified ColBERT Index via Product Quantization](https://arxiv.org/abs/2606.05568) | The sparsified index directly contributes an alternative retrieval substrate. |
...
Pseudo-relevance feedback methods developed for late-interaction retrieval. Related dense PRF and query decomposition appear in the background collection.
...
| ColBERTv2 | 2022 · NAACL | [ColBERTv2: Effective and Efficient Retrieval via Lightweight Late Interaction](https://aclanthology.org/2022.naacl-main.272/) | Denoised distillation is a substantive training contribution, beyond use as a backbone. |
...
| Matching and pruning analysis | 2024 · TOIS | [An Analysis on Matching Mechanisms and Token Pruning for Late-Interaction Models](https://doi.org/10.1145/3639818) | Matching-mechanism analysis directly diagnoses late-interaction behavior. |
...
| LateOn / mLateOn | 2026 · arXiv | [DenseOn with the LateOn: Fully Open Dense and Late-Interaction Models for Multilingual, Long-Context, and Code Search](https://arxiv.org/abs/2607.27178) | Open model training and adaptation are direct methodological contributions. |
...
| Spike Hijacking | 2026 · arXiv / LIR Workshop | [Spike Hijacking in Late-Interaction Retrieval](https://arxiv.org/abs/2604.05253) | Provides robustness diagnostics for local distractors and document-length effects. |
...
| Jina-ColBERT-v2 | 2024 · MRL Workshop | [Jina-colbert-v2: A general-purpose multilingual late interaction retriever](https://aclanthology.org/2024.mrl-1.11/) | Multilingual late-interaction modeling directly addresses language transfer. |
...
| LateOn / mLateOn | 2026 · arXiv | [DenseOn with the LateOn: Fully Open Dense and Late-Interaction Models for Multilingual, Long-Context, and Code Search](https://arxiv.org/abs/2607.27178) | Multilingual, long-context, and code retrieval are explicit extension settings. |
...
Selected work on emerging interaction units, agentic search, and evaluation. Agentic systems and benchmarks provide research context; they are not all late-interaction methods.
...
Additional historical, conceptual, and software-community references remain available in [references.bib](references.bib).
