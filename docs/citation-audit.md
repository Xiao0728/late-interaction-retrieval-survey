...
- SaMer is mapped to §11.1; ColChunk to §10.2; Flash-MaxSim/TileMaxSim to §11.2; POQD to §8.3 and §11.3. LITTA appears in both query-side and multimodal discussions. Introduction mentions are retained separately.
